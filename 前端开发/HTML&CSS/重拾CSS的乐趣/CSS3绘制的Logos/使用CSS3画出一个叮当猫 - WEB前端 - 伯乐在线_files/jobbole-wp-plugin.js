...
jQuery(document).ready(function ($) {
    ...
    $("#resource-submit-btn").bind("click", function () {
        ...
        var description = $('#submit_form_description').val();
    ...
    $("#group-topic-submit-btn").bind("click", function () {
        ...
        var topic_content = $('#submit_form_topic_content').val();
    ...
    $("#group-topic-preview-md-btn").bind("click", function () {
        ...
        var md_text = $('#submit_form_topic_content').val();
    ...
    $("#top-link-preview-md-btn").bind("click", function () {
        ...
        var md_text = $('#submit_form_source_article_excerpt').val();
    ...
    $("#hao-resource-preview-md-btn").bind("click", function () {
        ...
        var md_text = $('#submit_form_description').val();
    ...
    $("#crawl-article-submit-btn").bind("click", function () {
        ...
        var article_data = {
            ...
            content: $('#submit_form_article_content').html()
        };
    ...
    if(source_url === ''){
        ...
        ajaxSubmitReq.done(function (callbackData) {
            ...
            if (callbackData.jb_result == 0) {
                ...
                $('#submit_form_article_content').html(callbackData.article_content);
            }else{
...
function audit_group_topic(btn,id, title, tags, excerpt, audit_result, audit_msg){
    ...
    if (title === '') {
        alert("标题不能为空");
    } else if (title.length > 200 || excerpt.length > 5000) {
        alert("标题或内容超长");
    } else {
        var articleData = {
