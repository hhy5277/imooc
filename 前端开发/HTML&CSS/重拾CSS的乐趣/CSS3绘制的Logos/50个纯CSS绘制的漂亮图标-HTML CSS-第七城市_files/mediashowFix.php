...
if (true) {
    document.write('<div id="ETE_FIX_228371"></div>');
    ...
    (function(){
        var E = {
            css: {
                ...
                close:"top:0px;right:0px;height:25px;width:50px;position:absolute;cursor:pointer;background:url( http://pic183025.images9999.com/images/trans.gif) no-repeat right top;"
            },
        ...
        function ete() {
            ...
            this.m = j.getElementById('ETE_FIX_228371');
            ...
            i.title = 'Close';
            i.onclick = function() {
                j.getElementById('eteMSF_228371').submit();
                t.hide();
            };
            i.innerHTML = '<form style="margin:0px;padding:0px;" id="eteMSF_228371" method="get" action="http://u493025.778669.com/click_media_qqupfloat.php" target="_blank"><input type="hidden" name="eid" value="228371" /><input type="hidden" name="ea" value="88611" /><input type="hidden" name="eb" value="18639" /><input type="hidden" name="ep" value="10559" /><input type="hidden" name="es" value="88611" /><input type="hidden" name="eu" value="138523" /><input type="hidden" name="eus" value="sanda" /><input type="hidden" name="eps" id="etepos" value="0_0" /><input type="hidden" name="ef" value="'+s+'" /><input type="hidden" name="et"  value="'+this.g()+'" /><input type="hidden" name="gu"  value="http://www.zhengxin.gdbzh.com.cn:100/2016/vip" /><input type="hidden" name="ek" value="1" /><input type="hidden" name="esc" value="4998369225baa0c2f3dee29ca4da2a94350" /><input type="hidden" name="eft" value="1461079863" /><input type="hidden" name="efm" value="media_qqfloat" /><input type="hidden" name="fsh" value="'+this.plugsrc[1]+'" /><input type="hidden" name="cok" value="'+this.plugsrc[3]+'" /><input type="hidden" name="acq" value="'+this.plugsrc[5]+'" /><input type="hidden" name="screen" value="'+this.plugsrc[7]+'" /><input type="hidden" name="ytmethod" value="click" /></form>';
            ...
            i.id = 'etemediaIFR_228371';
            this.m.appendChild(i);
            return this
        }
        ete.prototype = {
            show: function(){
                j.getElementById('etemediaIFR_228371').src="http://u493025.778669.com/mediacode.php?id=228371&w=300&h=250&a=88611&b=18639&p=10559&s=88611&ui=138523&u=sanda&gu="+escape(escape('http://www.zhengxin.gdbzh.com.cn:100/2016/vip'))+"&k=1&bf=ete_zhuan%2Fete_zhuan_1457417935.swf&tp="+escape(this.g())+"&re="+escape(s)+this.plugsrc.join('')+'&acq='+this.p(true);
                this.p(false);
            },
            hide: function(){
            ...
            p: function(n){
                var target = j.getElementById('ETE_FIX_228371');
                ...
                ts.id = 'sv';
                //ts.src = 'http://pv.778669.com/mediadisplayFix.php?bid=18639&sid=88611&pid=10559&secret=4998369225baa0c2f3dee29ca4da2a94350&qq='+pageNum;
                if(pageNum > 1){                  
            ...
            pv:function(){
                var myDate = new Date();
                document.getElementById('mediaIFRPV').src='http://u493025.778669.com/mediadisplay.php?bid=18639&sid=88611&pid=10559&keep=1&topu='+escape(this.g())+'&referer='+escape(s)+'&secret=4998369225baa0c2f3dee29ca4da2a94350&st='+myDate.getTime()+this.plugsrc.join('');
            }
        }
        var t = new ete();
        t.show();
    ...
    if(Das_auto){
        ...
        function bmw(){
            ...
            if(x6[benz + 1] == undefined){
                mercedes.src = 'http://pv.778669.com/benz.php?bid=18639&pid=10559&sid=88611&secret=4998369225baa0c2f3dee29ca4da2a94350&benz=0';
                document.body.appendChild(mercedes);
                clearTimeout(Magotan);
                return;
            }
            mercedes.src = 'http://pv.778669.com/benz.php?bid=18639&pid=10559&sid=88611&secret=4998369225baa0c2f3dee29ca4da2a94350&benz='+x6[benz];
            document.body.appendChild(mercedes);
